							  ...
							  int hdmi_num)
{
	...
	/* speaker amp */
	ssp_amp = (sof_amp_only_quirk & SOF_SSP_AMP_MASK) >>
		  SOF_SSP_AMP_SHIFT;
	type_amp = (sof_amp_only_quirk & SOF_TYPE_AMP_MASK) >>
		   SOF_TYPE_AMP_SHIFT;
...
static int sof_audio_probe(struct platform_device *pdev)
{
	...
	sof_amp_only_audio_card.num_links = dmic_be_num + hdmi_num + 1;
